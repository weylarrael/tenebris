    ...
    >
      ...
      <Reveal className="relative mx-auto max-w-2xl px-6 text-center">
        ...
        <a
          ...
          className="mt-10 inline-flex items-center gap-3 rounded-md bg-gradient-to-r from-gold-dim via-gold to-gold-bright px-9 py-4 text-sm font-semibold uppercase tracking-[0.2em] text-void shadow-[0_0_26px_-4px_rgba(230,185,79,0.6)] transition hover:brightness-110"
        >
